...
FIRMWARE_DHSECAPP_SYMLINKS := $(addprefix $(TARGET_OUT_VENDOR_ETC)/firmware/,$(notdir $(FIRMWARE_DHSECAPP_IMAGES)))
...
QMPSECAP_SYMLINKS := $(addprefix $(TARGET_OUT_VENDOR_ETC)/firmware/,$(notdir $(QMPSECAP_IMAGES)))
...
SECUREMM_SYMLINKS := $(addprefix $(TARGET_OUT_VENDOR_ETC)/firmware/,$(notdir $(SECUREMM_IMAGES)))
...
SAMPLE_SYMLINKS := $(addprefix $(TARGET_OUT_VENDOR_ETC)/firmware/,$(notdir $(SAMPLE_IMAGES)))
